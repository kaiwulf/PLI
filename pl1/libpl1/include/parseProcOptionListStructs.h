	/* parseProcOptionListStructs.h
	 * ============================
	 *
	 * Definition of the structure ProcOptionList 
	 *
...
#ifndef PARSEPROCOPTIONLISTSTRUCTS_H_
#define PARSEPROCOPTIONLISTSTRUCTS_H_


struct ProcOptionList 
{ int main;
  int task;
};


#endif /*PARSEPROCOPTIONLISTSTRUCTS_H_*/
